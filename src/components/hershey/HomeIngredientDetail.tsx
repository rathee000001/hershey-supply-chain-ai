...
export default function HomeIngredientDetail({data,family,color}:{data:EnrichedArtifacts;family:FamilyName;color:string}){
 ...
 <StoryQuestions label="Ingredient detail views" value={tab} onChange={setTab} items={[
{id:"story",label:"The journey",question:"How does this ingredient enter the story?",hint:"Explore the recorded origin and preparation",art:family==="dairy"?"dairy":family==="sugar"?"sugar":family==="cocoa"?"cocoa":"minor"},
{id:"numbers",label:"Quantity & cost",question:"What does this ingredient contribute?",hint:"Compare the modeled quantity and price",art:"coins"},
{id:"sources",label:"Source context",question:"What does the research actually support?",hint:"Open the original documents",art:"report"}]}/>
