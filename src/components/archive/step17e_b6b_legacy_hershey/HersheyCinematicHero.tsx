        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-[3rem] border border-amber-100/20 bg-white/[0.06] p-6 shadow-2xl backdrop-blur">
            <div className="rounded-[2.4rem] border border-white/10 bg-[#210706]/80 p-6">
              ...
              <div className="relative flex min-h-[340px] items-center justify-center rounded-[2rem] border border-white/10 bg-black/30 p-8">
                {wrapperFront ? (
                  <img
                    src={wrapperFront}
                    alt="Hershey wrapper front"
                    className="max-h-72 w-full scale-110 object-contain drop-shadow-2xl"
                  />
                ) : (
